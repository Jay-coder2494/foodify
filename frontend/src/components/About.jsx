  ...
  return (
    <>
      ...
      <div className="container py-5" style={{ fontFamily: '"SUSE", sans-serif' }}>
        <h1 className="text-center mb-4 text-danger">About Foodify</h1>
        <div className="row">
          <div className="col-md-6">
            <h2 className="mb-3 text-warning">Who We Are</h2>
            <p>
              At , we are passionate about bringing the best culinary experiences to your doorstep. Whether you're craving local delicacies or international cuisine, Foodie connects you with the top restaurants in your area, ensuring that you get exactly what you want, when you want it.
            </p>
            <p>
